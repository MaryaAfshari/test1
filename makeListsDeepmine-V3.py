...
# Clear existing text files before writing
...
val_file_path = "val_list.txt"
test_file_path = "test_list.txt"

clear_file(train_file_path)
clear_file(val_file_path)
clear_file(test_file_path)

# Write train list to a file
write_list_to_file(train_list, train_file_path)

# Write validation list to a file
write_list_to_file(val_list, val_file_path)

# Write test list to a file
write_list_to_file(test_list, test_file_path)